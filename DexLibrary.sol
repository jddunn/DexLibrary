...
// Interfaces and libraries to interact with DEXes
// Meant for cross-chain support in contracts.
...
// Dex library
// We have the functions written instead of an interface because there's a fix needed to
// unwrap the ABI without overflowing (line 158).
library DexLibrary {
